...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-(--color-surface-invert)/50 backdrop-blur-none',
...
>(({ className, overlayClassName, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'tw-reset fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] bg-surface-pri translate-y-[-50%] gap-4 border p-6 shadow-lg duration-200 sm:rounded-lg md:w-full',
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn('body-large font-semibold', className)}
    {...props}
  />
));
