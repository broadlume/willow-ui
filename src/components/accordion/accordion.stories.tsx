...
export const StatusStyling: Story = {
  ...
  render: (args) => (
    <Accordion {...args} className="w-full space-y-4">
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger status="warning">
          Warning Notice
        </AccordionTrigger>
        <AccordionContent>
          Your current settings may impact system performance.
          Consider optimizing your configuration for better results.
        </AccordionContent>
      </AccordionItem>

      <AccordionItem value="item-3">
        <AccordionTrigger status="success">
          Success Status
        </AccordionTrigger>
        <AccordionContent>
          All changes have been saved and applied.
          Your system is now up to date with the latest configurations.
        </AccordionContent>
      </AccordionItem>

      <AccordionItem value="item-4">
        <AccordionTrigger status="info">
          Information
        </AccordionTrigger>
        <AccordionContent>
          A new version of the software is available.
          Please review the changes and update at your convenience.
        </AccordionContent>
      </AccordionItem>

      <AccordionItem value="item-5">
        <AccordionTrigger status="default">
          Default Style
        </AccordionTrigger>
        <AccordionContent>
