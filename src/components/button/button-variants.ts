...
const buttonVariants = cva(
  [
    'inline-flex h-9 items-center justify-center gap-2 overflow-hidden rounded-[100px] px-4 font-founders_grotesk text-xs font-semibold uppercase leading-none shadow tracking-[0.24px]',
