...
This means you'll need to add a `.npmrc` file to your project wherever your package.json file is to let npm know where to look & what credentials to use. Here's the file to copy+paste:
